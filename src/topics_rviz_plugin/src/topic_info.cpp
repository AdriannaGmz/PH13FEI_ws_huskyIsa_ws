...
TopicInfo::TopicInfo(const std::string topic_name,
                     const std::string topic_type,
                     const ros::Duration refresh_duration) :
        ...
        refresh_duration_(refresh_duration)
{
  ...
  if (topic_type_ == "std_msgs/Bool" ||
      topic_type_ == "std_msgs/Duration" ||
      topic_type_ == "std_msgs/String" ||
      topic_type_ == "std_msgs/Time")
  {
    display_ = std::make_shared<QLabel>();
  }
  else if (topic_type_ == "std_msgs/Int8" ||
      topic_type_ == "std_msgs/Int16" ||
      topic_type_ == "std_msgs/Int32" ||
      topic_type_ == "std_msgs/Int64" ||
      topic_type_ == "std_msgs/UInt8" ||
      topic_type_ == "std_msgs/UInt16" ||
      topic_type_ == "std_msgs/UInt32" ||
      topic_type_ == "std_msgs/UInt64" ||
      topic_type_ == "std_msgs/Float32" ||
      topic_type_ == "std_msgs/Float64")
  {
  ...
  {
    ROS_ERROR_STREAM("Unsupported built-in type, cannot display topic " << topic_name_ << " of type " << topic_type_);
...
void
TopicInfo::setMaximumRefreshRate(const ros::Duration d)
{
  refresh_duration_ = d;
...
void
TopicInfo::adjustLCDNumberOfDigitsHandler(const long unsigned number)
{
...
void
TopicInfo::boolCallback(const std_msgs::BoolConstPtr &msg)
{
  if (!refresh())
    return;
...
void
TopicInfo::durationCallback(const std_msgs::DurationConstPtr &msg)
{
  if (!refresh())
    return;
...
void
TopicInfo::float32Callback(const std_msgs::Float32ConstPtr &msg)
{
  if (!refresh())
    return;
...
void
TopicInfo::float64Callback(const std_msgs::Float64ConstPtr &msg)
{
  if (!refresh())
    return;
...
void
TopicInfo::int8Callback(const std_msgs::Int8ConstPtr &msg)
{
  if (!refresh())
    return;
...
void
TopicInfo::int16Callback(const std_msgs::Int16ConstPtr &msg)
{
  if (!refresh())
    return;
...
void
TopicInfo::int32Callback(const std_msgs::Int32ConstPtr &msg)
{
  if (!refresh())
    return;
...
void
TopicInfo::int64Callback(const std_msgs::Int64ConstPtr &msg)
{
  if (!refresh())
    return;
...
void
TopicInfo::stringCallback(const std_msgs::StringConstPtr &msg)
{
  if (!refresh())
    return;
...
void
TopicInfo::timeCallback(const std_msgs::TimeConstPtr &msg)
{
  if (!refresh())
    return;
...
void
TopicInfo::uint8Callback(const std_msgs::UInt8ConstPtr &msg)
{
  if (!refresh())
    return;
...
void
TopicInfo::uint16Callback(const std_msgs::UInt16ConstPtr &msg)
{
  if (!refresh())
    return;
...
void
TopicInfo::uint32Callback(const std_msgs::UInt32ConstPtr &msg)
{
  if (!refresh())
    return;
...
void
TopicInfo::uint64Callback(const std_msgs::UInt64ConstPtr &msg)
{
  if (!refresh())
    return;
