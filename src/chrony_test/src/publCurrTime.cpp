...
#include <sstream>          //to manipulate string data in msg




int main(int argc, char **argv){
  ros::init(argc, argv, "talker_time");    /** name of this node if not overriden */
  ros::NodeHandle n;


  //chatter_time is the name of the TOPIC 1
  ros::Publisher chatter_time_pub = n.advertise<std_msgs::Header>("/chatter_time", 1000);
