...
def Initialize(lib_path = None, manualport=None,manualbaud=None,useDll=True, **kwargs):
    if useDll:
        uart = UART(dllPath=lib_path) #Open the UART dll
    else:
        raise Exception("pyserial not implemented")
